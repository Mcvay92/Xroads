      ...
      <div className="col-sm-12 col-lg-10 col-md-10 margin-auto float-none">
        <Grid container justify="center" alignItems="center" direction="column">
          <img
            ...
            src={
              logo
                ? `https://crossroad-test.s3.us-east-2.amazonaws.com/logo/${logo}`
                : defaultStartupLogo
            }
            ...
            <div className="carousel">
              ...
              <ItemsCarousel
                ...
                requestToChangeActive={value =>
                  this.setState({ activeMemberIndex: value })
                }
                    ...
                    {members[i] ? (
                      <a
                        ...
                        style={{
                          ...
                          right: 0,
                          bottom: 0,
                          display: members[i].linkedin ? "block" : "none"
                        }}
                      >
                        <img
                          src={linkedinLogoSquare}
                          style={{ width: "35px", height: "35px" }}
                          alt="user linkedin account"
                        />
                      </a>
                    ) : null}
                  </MaterialCard>
            ...
            <div className="normal-cards-view">
              ...
              <div>
                {Array.from(new Array(this.getCardsNum(0))).map((_, i) => (
                  <MaterialCard
                    CustomWidth={`${Math.round(100 / this.getCardsNum(0)) -
                      1.5}%`}
                  >
                    <div
                      className="card-image"
          ...
          {roles.length >= this.getCardsNum(0) ? (
            <div className="carousel">
              ...
              <ItemsCarousel
                ...
                requestToChangeActive={value =>
                  this.setState({ activeRoleIndex: value })
                }
                rightChevron={<p className="card-controller">{">"}</p>}
                leftChevron={<p className="card-controller">{"<"}</p>}
              >
